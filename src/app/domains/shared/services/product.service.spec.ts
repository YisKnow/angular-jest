...
describe("ProductService", () => {
  ...
  describe("getProducts", () => {
    ...
    it("should get products by category_id", () => {
      ...
      const req = spectator.expectOne(
        `${environment.apiUrl}/api/v1/products?categoryId=${categoryId}`,
        HttpMethod.GET,
      );
      req.flush(fakeProducts);
    });
    ...
    it("should get products by category_slug", () => {
      ...
      const req = spectator.expectOne(
        `${environment.apiUrl}/api/v1/products?categorySlug=${categorySlug}`,
        HttpMethod.GET,
      );
      req.flush(fakeProducts);
    });
  ...
  describe("getOneBySlug", () => {
    it("should get one product by slug", () => {
      ...
      const req = spectator.expectOne(
        `${environment.apiUrl}/api/v1/products/slug/${productSlug}`,
        HttpMethod.GET,
      );
      req.flush(fakeProduct);
    });
  ...
  describe("getRelatedProducts", () => {
    it("should get related products", () => {
      ...
      const req = spectator.expectOne(
        `${environment.apiUrl}/api/v1/products/slug/${productSlug}/related`,
        HttpMethod.GET,
      );
      req.flush(fakeProducts);
    });
